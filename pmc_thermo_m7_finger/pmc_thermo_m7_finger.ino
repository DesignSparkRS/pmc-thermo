  ...
  if (buffer.length() > 0) {
    switch (buffer.toInt()) {
      case 0:
        ...
        digital_outputs.set(IOCH02, LOW);
        digital_outputs.set(IOCH03, LOW);
        digital_outputs.set(IOCH04, LOW);
        digital_outputs.set(IOCH05, LOW);                
        break;
      case 1:
      ...
      case 2:
        digital_outputs.set(IOCH01, HIGH);
        digital_outputs.set(IOCH02, HIGH);
        digital_outputs.set(IOCH03, LOW);
        digital_outputs.set(IOCH04, LOW);
        digital_outputs.set(IOCH05, LOW); 
        break;
      case 3:
        digital_outputs.set(IOCH01, HIGH);
        digital_outputs.set(IOCH02, HIGH);
        digital_outputs.set(IOCH03, HIGH);
        digital_outputs.set(IOCH04, LOW);
        digital_outputs.set(IOCH05, LOW); 
        break;
      case 4:
        ...
        digital_outputs.set(IOCH02, HIGH);
        digital_outputs.set(IOCH03, HIGH);
        digital_outputs.set(IOCH04, HIGH);
        digital_outputs.set(IOCH05, LOW); 
        break;
      case 5:
        digital_outputs.set(IOCH01, HIGH);
        ...
        digital_outputs.set(IOCH03, HIGH);
        digital_outputs.set(IOCH04, HIGH);
        digital_outputs.set(IOCH05, HIGH); 
        break;                                       
    }
  }
}
